...
public:
    ...
    void exportData(std::vector<std::pair<float,PositionVector>>& values,const MSVehicle* v);
    void exportOldBoundingBox(std::vector<std::pair<float,PositionVector>>& values,const MSVehicle* v);
